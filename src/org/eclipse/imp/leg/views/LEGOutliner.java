 ...
 *
 */
public class LEGOutliner extends OutlinerBase {
    /*
    ...
    private final class OutlineVisitor extends AbstractVisitor {
        ...
        public boolean visit(declarationStmt0 n) {
            declaration0 decl= (declaration0) n.getdeclaration();
            addSubItem(decl.getprimitiveType() + " " + decl.getidentifier().toString(), n);
            return true;
        }
        ...
        public boolean visit(functionDeclaration0 n) {
            pushSubItem(n.getfunctionHeader().getidentifier().toString(), n);
            return true;
        }
        @Override
        public void endVisit(functionDeclaration0 n) {
            popSubItem();
        }
    }
