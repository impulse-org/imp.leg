 ...
 *</b>
 */
public class expression__expression_NOTEQUAL_term extends ASTNode implements Iexpression
{
    ...
    public expression__expression_NOTEQUAL_term(IToken leftIToken, IToken rightIToken,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof expression__expression_NOTEQUAL_term)) return false;
        if (! super.equals(o)) return false;
        expression__expression_NOTEQUAL_term other = (expression__expression_NOTEQUAL_term) o;
